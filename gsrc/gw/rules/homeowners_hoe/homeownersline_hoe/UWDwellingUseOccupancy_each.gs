 ...
 */
class UWDwellingUseOccupancy_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
    ...
    if(((homeowner.Dwelling.DwellingUsage == DwellingUsage_HOE.TC_PRIM ||
        ...
        homeowner.Dwelling.DwellingUsage == DwellingUsage_HOE.TC_RENT) &&
        ...
        homeowner.Dwelling.DwellingUsage == DwellingUsage_HOE.TC_RENT && homeowner.Dwelling.Occupancy ==	DwellingOccupancyType_HOE.TC_OWNER ){
