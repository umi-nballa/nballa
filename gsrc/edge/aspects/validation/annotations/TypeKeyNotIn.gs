...
/**
 * Restriction on the typekey. Typekey should NOT be in a list of explicit values.
 */
class TypeKeyNotIn implements IMetaMultiFactory {
  ...
  override function getState(): Object[] {
    return {
      new ValidationRuleDTO(
        Expr.isNot(Expr.call(ValidationFunctions#typekeyIn(gw.entity.TypeKey, gw.entity.TypeKey[]), {Validation.VALUE, Expr.dtoConst(_values)})),
