...
class BP7AddlInsdControllingInterestScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdControllingInterestScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdControllingInterestScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withAddress(value : String) : BP7AddlInsdControllingInterestScheduledItemExpression {
