...
class HPXCompositionUnitMapper {
  ...
  */
    ...
    var documentForm29 = compositionUnitMapper.createDocumentForm("DP04731202","English","DP04731202", new java.util.Date(),"07-02", false)
    var documentForm30 = compositionUnitMapper.createDocumentForm("DP17670788","English","DP17670788", new java.util.Date(),"07-02", false)
    var documentForm31 = compositionUnitMapper.createDocumentForm("HO03120511","English","HO03120511", new java.util.Date(),"07-02", false)
    var documentForm32 = compositionUnitMapper.createDocumentForm("HO03170901","English","HO03170901", new java.util.Date(),"07-02", false)
    var documentForm33 = compositionUnitMapper.createDocumentForm("HO03330503","English","HO03330503", new java.util.Date(),"07-02", false)
    var documentForm34 = compositionUnitMapper.createDocumentForm("HO03340503","English","HO03340503", new java.util.Date(),"07-02", false)
    var documentForm35 = compositionUnitMapper.createDocumentForm("HO03630612","English","HO03630612", new java.util.Date(),"07-02", false)
    var documentForm36 = compositionUnitMapper.createDocumentForm("HO04201000","English","HO04201000", new java.util.Date(),"07-02", false)
    var documentForm37 = compositionUnitMapper.createDocumentForm("HO04260402","English","HO04260402", new java.util.Date(),"07-02", false)
    var documentForm38 = compositionUnitMapper.createDocumentForm("HO04270402","English","HO04270402", new java.util.Date(),"07-02", false)
    var documentForm39 = compositionUnitMapper.createDocumentForm("HO04280402","English","HO04280402", new java.util.Date(),"07-02", false)
    var documentForm40 = compositionUnitMapper.createDocumentForm("HO04361000","English","HO04361000", new java.util.Date(),"07-02", false)
    var documentForm41 = compositionUnitMapper.createDocumentForm("HO04411000","English","HO04411000", new java.util.Date(),"07-02", false)
    var documentForm42 = compositionUnitMapper.createDocumentForm("HO04541000","English","HO04541000", new java.util.Date(),"07-02", false)
    ...
    var documentForm45 = compositionUnitMapper.createDocumentForm("HO04840612","English","HO04840612", new java.util.Date(),"07-02", false)
    ...
    var documentForm50 = compositionUnitMapper.createDocumentForm("HO32100612","English","HO32100612", new java.util.Date(),"07-02", false)
    var documentForm51 = compositionUnitMapper.createDocumentForm("HO32200612","English","HO32200612", new java.util.Date(),"07-02", false)
    var documentForm52 = compositionUnitMapper.createDocumentForm("HO32270612","English","HO32270612", new java.util.Date(),"07-02", false)
    var documentForm53 = compositionUnitMapper.createDocumentForm("HO32540612","English","HO32540612", new java.util.Date(),"07-02", false)
    ...
    var documentForm58 = compositionUnitMapper.createDocumentForm("TDP0070792","English","TDP0070792", new java.util.Date(),"07-02", false)
    ...
    var documentForm68 = compositionUnitMapper.createDocumentForm("UIHOXC0607","English","UIHOXC0607", new java.util.Date(),"07-02", false)
    ...
    var documentForm76 = compositionUnitMapper.createDocumentForm("NOCPDP0110","English","NOCPDP0110", new java.util.Date(),"07-02", false)
    var documentForm77 = compositionUnitMapper.createDocumentForm("MRCO0508","English","MRCO0508", new java.util.Date(),"07-02", false)
    var documentForm78 = compositionUnitMapper.createDocumentForm("HO04610511","English","HO04610511", new java.util.Date(),"07-02", false)
    var documentForm79 = compositionUnitMapper.createDocumentForm("HO04511000","English","HO04511000", new java.util.Date(),"07-02", false)
    var documentForm80 = compositionUnitMapper.createDocumentForm("HO04481000","English","HO04481000", new java.util.Date(),"07-02", false)
    ...
    documentForms.add(documentForm29)
    documentForms.add(documentForm30)
    documentForms.add(documentForm31)
    documentForms.add(documentForm32)
    documentForms.add(documentForm33)
    documentForms.add(documentForm34)
    documentForms.add(documentForm35)
    documentForms.add(documentForm36)
    documentForms.add(documentForm37)
    documentForms.add(documentForm38)
    documentForms.add(documentForm40)
    documentForms.add(documentForm41)
    documentForms.add(documentForm42)
    documentForms.add(documentForm43)
    documentForms.add(documentForm44)
    documentForms.add(documentForm45)
    ...
    documentForms.add(documentForm50)
    documentForms.add(documentForm51)
    documentForms.add(documentForm52)
    documentForms.add(documentForm53)
    ...
    documentForms.add(documentForm58)
    ...
    documentForms.add(documentForm68)
    ...
    documentForms.add(documentForm76)
    documentForms.add(documentForm77)
    documentForms.add(documentForm78)
    documentForms.add(documentForm79)
    documentForms.add(documentForm80)
