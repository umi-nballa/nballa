...
class BP7AddlInsdStatePoliticalSubdivisionsScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdStatePoliticalSubdivisionsScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdStatePoliticalSubdivisionsScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withAddress(value : String) : BP7AddlInsdStatePoliticalSubdivisionsScheduledItemExpression {
