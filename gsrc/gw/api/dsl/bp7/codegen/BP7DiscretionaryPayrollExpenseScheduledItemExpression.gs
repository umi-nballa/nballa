...
class BP7DiscretionaryPayrollExpenseScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7DiscretionaryPayrollExpenseScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7DiscretionaryPayrollExpenseScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withJobClassificationsOrEmployees(value : String) : BP7DiscretionaryPayrollExpenseScheduledItemExpression {
    _builder.withStringCol1(value)
    return this
  }
  
  function withMaximumNumberOfDaysForDiscretionaryPayrollExpense(value : String) : BP7DiscretionaryPayrollExpenseScheduledItemExpression {
