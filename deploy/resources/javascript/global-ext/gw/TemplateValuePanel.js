...
Ext.define('gw.TemplateValuePanel', {
  ...
  initComponent: function () {
    ...
    var labelClsExtra = this.labelClsExtra;
    ...
    // See PL-26317
    if (needsWrapper) {
      var containerWrapperConfig = { xtype: 'fieldcontainer', items: tempItems, fieldLabel: this.fieldLabel,
                                vertical: true, labelStyle: this.labelStyle, labelClsExtra: this.labelClsExtra };
      if (this.labelWidth) {
