...
class BP7AddlInsdEngineersArchitectsSurveyorsNotEngagedBScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdEngineersArchitectsSurveyorsNotEngagedBScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdEngineersArchitectsSurveyorsNotEngagedBScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withAddress(value : String) : BP7AddlInsdEngineersArchitectsSurveyorsNotEngagedBScheduledItemExpression {
