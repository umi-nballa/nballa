...
uses gw.policy.PolicyLineConfiguration
 ...
 class BP7LineSchedCondItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : BP7LineSchedCondItem as readonly Owner

  construct(item : BP7LineSchedCondItem) {
    _owner = item
  }
  ...
  override function addCondition(clause : PolicyCondition) {
   _owner.Condition = clause as BP7LineSchedCondItemCond
  }
