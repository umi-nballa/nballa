...
class BP7AddlInsdStatePoliticalSubdivisionsPermitsScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdStatePoliticalSubdivisionsPermitsScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdStatePoliticalSubdivisionsPermitsScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withAddress(value : String) : BP7AddlInsdStatePoliticalSubdivisionsPermitsScheduledItemExpression {
