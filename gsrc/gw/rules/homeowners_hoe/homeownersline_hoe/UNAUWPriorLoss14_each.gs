 ...
 */
class UNAUWPriorLoss14_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
   ...
   // Claim Amount - HOPriorLosses_Ext.ClaimPayment. ClaimAmount
    //Any "Risk" loss with CLUE Cause of Loss of "Theft", THFSC", "VMM" in the last 5 years with a loss date prior to purchase date of the property AND that
