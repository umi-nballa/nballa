...
class BP7AddlInsdOwnersLesseesOrContrctrsCompldOpsScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdOwnersLesseesOrContrctrsCompldOpsScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdOwnersLesseesOrContrctrsCompldOpsScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withLocationAndDescription(value : String) : BP7AddlInsdOwnersLesseesOrContrctrsCompldOpsScheduledItemExpression {
