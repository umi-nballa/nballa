...
enhancement CostEnhancement : Cost {
   ...
   * subject to accrual it must be premium and it is proratable.  Flat rate is not subject to accrual
   * and user defined could be anything
   */
  property get SubjectToAccrual() : boolean {
    return (this.RateAmountType == TC_STDPREMIUM or this.RateAmountType == TC_NONSTDPREMIUM) and this.ProrationMethod == TC_PRORATABYDAYS
  }
