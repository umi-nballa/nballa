...
class PARatingEngine extends AbstractRatingEngine<PersonalAutoLine> {
  ...
  // THIS IS A TEST IMPLEMENTATION. DO NOT COPY IT FOR PRODUCTION PURPOSES.
  // It can return a varying number of days, depending on when the term starts. This
  // makes it easy to write test assertions, but it's terribly wrong for a production
  // implementation.
  override protected property get NumDaysInCoverageRatedTerm() : int {
    ...
    return p.financialDaysBetween(endDate, Branch.StartOfRatedTerm)
  }
