...
class BP7LineSchedCovItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : BP7LineSchedCovItem as readonly Owner
  ...
  override function addCoverage(clause : Coverage) {
   _owner.addToCoverages(clause as BP7LineSchedCovItemCov)
  }

  override function removeCoverage(clause : Coverage) {
    _owner.removeFromCoverages(clause as BP7LineSchedCovItemCov)
  }
