...
class BP7AddlInsdGrantorOfFranchiseEndorsementScheduledItemExpression extends DataBuilderExpression<BP7LocSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdGrantorOfFranchiseEndorsementScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdGrantorOfFranchiseEndorsementScheduledItemExpression {
