 ...
 */
class UNAACT29051045 implements IRuleCondition<PolicyPeriod>{
...
// (Note: replaces review and approval uw activity)
    ...
    if (!period.HomeownersLine_HOEExists && period.Job.Subtype==typekey.Job.TC_RENEWAL && period.Status == typekey.PolicyPeriodStatus.TC_QUOTED)
    {
