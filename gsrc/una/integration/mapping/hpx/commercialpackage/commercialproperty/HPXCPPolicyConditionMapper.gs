...
class HPXCPPolicyConditionMapper extends HPXPolicyConditionMapper {
  ...
  override function createScheduleList(currentPolicyCondition: PolicyCondition, transactions : java.util.List<Transaction>)
    ...
    switch (currentPolicyCondition.PatternCode) {
      case "CPFloridaPolicyChangesCondition_EXT" :
          var floridaPropertyChanges = createFloridaPropertyChanges(currentPolicyCondition, transactions)
  ...
  override function createDeductibleScheduleList(currentPolicyCondition: PolicyCondition, transactions : java.util.List<Transaction>)
    ...
    switch (currentPolicyCondition.PatternCode) {
      case "CPFloridaHurricanePercentCondition_EXT" :
          var calendarYearHurricaneDeductible = createCalendarYearHurricaneDeductible(currentPolicyCondition, transactions)
          for (item in calendarYearHurricaneDeductible) { deductibles.add(item)}
          break
      case "CPFloridaEachHurricanePerctCondition_EXT" :
          var perOccurenceHurricaneDeductible = createPerOccurenceHurricaneDeductible(currentPolicyCondition, transactions)
  ...
  function createCalendarYearHurricaneDeductible(currentPolicyCondition: PolicyCondition, transactions : java.util.List<Transaction>)  : java.util.List<wsi.schema.una.hpx.hpx_application_request.types.complex.DeductibleType> {
    var deductibles = new java.util.ArrayList<wsi.schema.una.hpx.hpx_application_request.types.complex.DeductibleType>()
  ...
  function createPerOccurenceHurricaneDeductible(currentPolicyCondition: PolicyCondition, transactions : java.util.List<Transaction>)  : java.util.List<wsi.schema.una.hpx.hpx_application_request.types.complex.DeductibleType> {
    var deductibles = new java.util.ArrayList<wsi.schema.una.hpx.hpx_application_request.types.complex.DeductibleType>()
    var deductibleType = (currentPolicyCondition.PolicyLine as CommercialPropertyLine).hurricanededtype
  ...
  private function createFloridaPropertyChanges(currentPolicyCondition: PolicyCondition, transactions : java.util.List<Transaction>)  : java.util.List<wsi.schema.una.hpx.hpx_application_request.types.complex.LimitType> {
    var limits = new java.util.ArrayList<wsi.schema.una.hpx.hpx_application_request.types.complex.LimitType>()
    ...
    var previousPolicyPeriod = currentPolicyPeriod.BasedOn
