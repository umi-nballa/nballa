...
class BP7RestaurantsLossOrDamageToCustomersAutosLegalLiaScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7RestaurantsLossOrDamageToCustomersAutosLegalLiaScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7RestaurantsLossOrDamageToCustomersAutosLegalLiaScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withLocation(value : DataBuilderExpression) : BP7RestaurantsLossOrDamageToCustomersAutosLegalLiaScheduledItemExpression {
    _builder.withLocation(value.DataBuilder)
    return this
  }
