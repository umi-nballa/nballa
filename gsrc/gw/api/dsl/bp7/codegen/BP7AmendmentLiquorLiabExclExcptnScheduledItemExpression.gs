...
class BP7AmendmentLiquorLiabExclExcptnScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AmendmentLiquorLiabExclExcptnScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AmendmentLiquorLiabExclExcptnScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withDescription(value : String) : BP7AmendmentLiquorLiabExclExcptnScheduledItemExpression {
