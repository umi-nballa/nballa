...
class CalcRoutineParameterBuilder extends DataBuilder<CalcRoutineParameter, CalcRoutineParameterBuilder> {
  ...
  function withCoverageCode(coveragePattern : CoveragePattern) : CalcRoutineParameterBuilder {
    set(CalcRoutineParameter.Type.TypeInfo.getProperty("CoveragePattern"), coveragePattern.CodeIdentifier)
    return this
  }
  
  function withCoverageWrapper(wrapperClass : IType) : CalcRoutineParameterBuilder {
    set(CalcRoutineParameter.Type.TypeInfo.getProperty("UseWrapper"), true)
    set(CalcRoutineParameter.Type.TypeInfo.getProperty("WrapperClass"), wrapperClass.Name)
    return this
  }
