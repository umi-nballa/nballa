...
class HPXSWRRatingHelper {
  ...
  function getSWRConnectionPre2001SWR(policyPeriod : PolicyPeriod) : HPXEstimatedDiscount {
    ...
    var ratingFactor = ratingHelper.getRatingFactor(policyPeriod, "ho_windstorm_loss_reduction_terrain_B_FL", typekey.Jurisdiction.TC_FL, {"Non-FBC", "A", "Toe Nails", "None", "Other Roof", typekey.SecondaryWaterResis_Ext.TC_SWR.DisplayName})
