 ...
 */
class UWProtectionClass10_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowners : HomeownersLine_HOE) : RuleEvaluationResult {
    ...
    if(protectionClass != null && protectionClass == ProtectionClassCode_Ext.TC_10 && !homeowners.Dwelling.HOLocation.ProtectedSubDivision_Ext){
