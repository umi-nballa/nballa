...
class OFACWorkController {
  private static final var OFAC_ACTIVITY_PATTERN_CODES_TO_QUEUE : Map<String, String> = {"OFAC1" -> ActivityUtil.ACTIVITY_QUEUE.CSR.QueueName, "OFAC2" -> ActivityUtil.ACTIVITY_QUEUE.COMPLIANCE_OFAC.QueueName, "OFAC3" -> ActivityUtil.ACTIVITY_QUEUE.CSR_MANAGER.QueueName}
