...
class BP7ContrctrsToolsAndEquipmntScheduleScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7ContrctrsToolsAndEquipmntScheduleScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7ContrctrsToolsAndEquipmntScheduleScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withDescription(value : String) : BP7ContrctrsToolsAndEquipmntScheduleScheduledItemExpression {
    _builder.withStringCol1(value)
    return this
  }
  
  function withLimit(value : java.lang.Integer) : BP7ContrctrsToolsAndEquipmntScheduleScheduledItemExpression {
