...
class BP7AddlInsdOwnersLesseesContrctrsScheduledItemExpression extends DataBuilderExpression<BP7LocSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdOwnersLesseesContrctrsScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdOwnersLesseesContrctrsScheduledItemExpression {
