...
class ProxyScheduleForeignKeyPropertyInfo extends AbstractSchedulePropertyInfo {
  ...
  function toSchedulePropertyInfo<T extends Schedule & Clause>(owner : T) : SchedulePropertyInfo {
  ...
  protected function newValueRangeGetterInstance<T extends Schedule & Clause>(owner : T) : IValueRangeGetter {
  ...
  function getPropertyInfo<T extends Schedule & Clause>(owner : T) : IEntityPropertyInfo {
