 ...
 */
class UNAUWPriorLoss12_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
   ...
   // Claim Amount - HOPriorLosses_Ext.ClaimPayment. ClaimAmount
    ...
    homeowner.HOPriorLosses_Ext.each( \ elt ->
    {
      ...
      {
        if(elt1.LossCause_Ext == typekey.LossCause_Ext.TC_SMOKE && DateUtil.addYears(elt.ClaimDate as java.util.Date, 5)>new java.util.Date())
