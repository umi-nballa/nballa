...
class BP7LossRentalValueLandlordDesignatedPayeeScheduledItemExpression extends DataBuilderExpression<BP7LocSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7LossRentalValueLandlordDesignatedPayeeScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7LossRentalValueLandlordDesignatedPayeeScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withName(value : String) : BP7LossRentalValueLandlordDesignatedPayeeScheduledItemExpression {
    _builder.withStringCol1(value)
    return this
  }
  
  function withDesignationOfPremises(value : String) : BP7LossRentalValueLandlordDesignatedPayeeScheduledItemExpression {
