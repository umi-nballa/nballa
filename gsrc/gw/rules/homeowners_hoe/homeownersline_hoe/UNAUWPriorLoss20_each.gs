 ...
 */
class UNAUWPriorLoss20_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
   ...
   // Claim Amount - HOPriorLosses_Ext.ClaimPayment. ClaimAmount
    ...
    //Any "Subject" loss with CLUE  Cause of Loss of "Theft", THFSC", "VMM" in the last 3 years,  with a loss date after purchase date of the property AND
