 ...
 */
class UNAUWPriorLoss22_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
   ...
   //1 prior loss in last 5 years with CLUE or Agent Cause of Loss = "SINK", regarless of amount paid.
    ...
    homeowner.HOPriorLosses_Ext.each( \ elt ->
        {
          ...
          {
            if(elt1.LossCause_Ext == typekey.LossCause_Ext.TC_SINK  && DateUtil.addYears(elt.ClaimDate as java.util.Date, 5)>new java.util.Date())
