...
gw.app = function() {
  ...
  function _requestCallback (requestOptions, success, response) {
    ...
    try {
      ...
      gw.app.showAlert(gw.app.localize("ExtJS.Alert.InvalidServerResponse", response.refreshText));
      return;
    }
    ...
    initPage: function(view, config, commands) {
      ...
      Ext.onReady(function() {
        ...
        try {
          ...
          // TODO: This probably wants to be localized
          gw.app.showAlert("Browser DOM Storage disabled: User preferences will not be stored after page refresh in this browser version.")
        }
