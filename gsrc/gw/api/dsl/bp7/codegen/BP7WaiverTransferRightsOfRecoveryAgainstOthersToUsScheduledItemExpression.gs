...
class BP7WaiverTransferRightsOfRecoveryAgainstOthersToUsScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCondItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7WaiverTransferRightsOfRecoveryAgainstOthersToUsScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7WaiverTransferRightsOfRecoveryAgainstOthersToUsScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withDescription(value : String) : BP7WaiverTransferRightsOfRecoveryAgainstOthersToUsScheduledItemExpression {
