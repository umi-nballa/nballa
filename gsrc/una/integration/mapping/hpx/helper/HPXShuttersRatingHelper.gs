...
class HPXShuttersRatingHelper {
  ...
  function getShuttersConnectionPre2001Intermediate(policyPeriod : PolicyPeriod) : HPXEstimatedDiscount {
    var estimatedDiscount = new HPXEstimatedDiscount()
    var ratingHelper = new HPXRatingHelper()
    var ratingFactor = ratingHelper.getRatingFactor(policyPeriod, "ho_windstorm_loss_reduction_terrain_B_FL", typekey.Jurisdiction.TC_FL, {"Non-FBC", "A", "Toe Nails", "Basic - Windows", "Other Roof", typekey.SecondaryWaterResis_Ext.TC_NOSWR.DisplayName})
  ...
  function getShuttersConnectionPre2001HurricaneProtection(policyPeriod : PolicyPeriod) : HPXEstimatedDiscount {
    var estimatedDiscount = new HPXEstimatedDiscount()
    var ratingHelper = new HPXRatingHelper()
    var ratingFactor = ratingHelper.getRatingFactor(policyPeriod, "ho_windstorm_loss_reduction_terrain_B_FL", typekey.Jurisdiction.TC_FL, {"Non-FBC", "A", "Toe Nails", "Hurricane - Windows", "Other Roof", typekey.SecondaryWaterResis_Ext.TC_NOSWR.DisplayName})
  ...
  function getShuttersConnectionPost2001Intermediate(policyPeriod : PolicyPeriod) : HPXEstimatedDiscount {
    var estimatedDiscount = new HPXEstimatedDiscount()
    var ratingHelper = new HPXRatingHelper()
    var ratingFactor = ratingHelper.getRatingFactor(policyPeriod, "ho_windstorm_loss_reduction_credits_new_construction_other_roof_shape_nonhvhz", typekey.Jurisdiction.TC_FL, {typekey.RoofDecking_Ext.TC_OTHERROOFDECK.DisplayName, typekey.Terrain_Ext.TC_TERRAINB.DisplayName, typekey.FBCWindSpeed_Ext.TC_110.DisplayName, typekey.WindSpeedOfDesign_Ext.TC_GREATERTHANOREQUAL110.DisplayName, typekey.InternalPressureDsgn_Ext.TC_ENCLOSED.DisplayName, "NO", typekey.SecondaryWaterResis_Ext.TC_NOSWR.DisplayName, typekey.OpeningProtection_Ext.TC_WINDOWS.DisplayName})
  ...
  function getShuttersConnectionPost2001HurricaneProtection(policyPeriod : PolicyPeriod) : HPXEstimatedDiscount {
    var estimatedDiscount = new HPXEstimatedDiscount()
    var ratingHelper = new HPXRatingHelper()
    var ratingFactor = ratingHelper.getRatingFactor(policyPeriod, "ho_windstorm_loss_reduction_credits_new_construction_other_roof_shape_nonhvhz", typekey.Jurisdiction.TC_FL, {typekey.RoofDecking_Ext.TC_OTHERROOFDECK.DisplayName, typekey.Terrain_Ext.TC_TERRAINB.DisplayName, typekey.FBCWindSpeed_Ext.TC_110.DisplayName, typekey.WindSpeedOfDesign_Ext.TC_GREATERTHANOREQUAL110.DisplayName, typekey.InternalPressureDsgn_Ext.TC_ENCLOSED.DisplayName, "NO", typekey.SecondaryWaterResis_Ext.TC_NOSWR.DisplayName, typekey.OpeningProtection_Ext.TC_ALL.DisplayName.toUpperCase()})
