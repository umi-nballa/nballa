...
class BP7LocSchedExclItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : BP7LocSchedExclItem as readonly Owner

  construct(item : BP7LocSchedExclItem) {
    _owner = item
  }
  ...
  override function addExclusion(clause : Exclusion) {
   _owner.Exclusion = clause as BP7LocSchedExclItemExcl
  }
