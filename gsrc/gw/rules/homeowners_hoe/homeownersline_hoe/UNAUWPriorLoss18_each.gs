 ...
 */
class UNAUWPriorLoss18_each implements IRuleCondition<HomeownersLine_HOE>{
...
//Any "Risk" loss with CLUE Cause of Loss of "Theft", THFSC", "VMM" in the last 3 years with a loss date prior to purchase date of the property AND
