...
uses gw.policy.PolicyLineConfiguration
 ...
 class BP7ClassSchedCondItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : BP7ClassSchedCondItem as readonly Owner

  construct(item : BP7ClassSchedCondItem) {
    _owner = item
  }
  ...
  override function addCondition(clause : PolicyCondition) {
   _owner.Condition = clause as BP7ClassSchedCondItemCond
  }
