 ...
 */
class UNAUWPriorLoss25_each implements IRuleCondition<HomeownersLine_HOE>{
...
//Any prior loss with CLUE or Agent Cause of Loss = "Fire" and Date of Loss is in last 5 years
