...
class BP7OffPremIntrpOfBusnVehiclesAndMobileEquipmentScheduledItemExpression extends DataBuilderExpression<BP7LocSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7OffPremIntrpOfBusnVehiclesAndMobileEquipmentScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7OffPremIntrpOfBusnVehiclesAndMobileEquipmentScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withDescriptionOfScheduledProperty(value : String) : BP7OffPremIntrpOfBusnVehiclesAndMobileEquipmentScheduledItemExpression {
