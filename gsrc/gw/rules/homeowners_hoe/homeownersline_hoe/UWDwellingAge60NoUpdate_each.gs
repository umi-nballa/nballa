 ...
 */
class UWDwellingAge60NoUpdate_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
    ...
    if(dwellingAge > 60  &&  ( roofreplaceYear > 35 || HeatReplaceYear > 35 || ElectReplaceYear > 35 )){
