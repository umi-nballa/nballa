 ...
 */
class UNAUWInsScoreClue3_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
   ...
   //InScore , 626 and 1 prior non weather loss (CLUE Cause of loss =  ANY other than"Flood", "Freez", "Hail", "LAE", "Light", "Earthmovement", "Earthquake", "Sinkhole", "Weath", "Wind", "Water", "Applicance", "Mold"
