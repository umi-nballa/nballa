...
class BP7AddlInsdMortgageeAssigneeReceiverScheduledItemExpression extends DataBuilderExpression<BP7LocSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdMortgageeAssigneeReceiverScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdMortgageeAssigneeReceiverScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withDesignationOfPremises(value : String) : BP7AddlInsdMortgageeAssigneeReceiverScheduledItemExpression {
