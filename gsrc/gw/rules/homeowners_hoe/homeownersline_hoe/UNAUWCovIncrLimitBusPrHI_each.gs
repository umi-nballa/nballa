 ...
 */
class UNAUWCovIncrLimitBusPrHI_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
    ...
    && homeowner.Dwelling.HODW_BusinessProperty_HOE_Ext.HODW_OnPremises_Limit_HOETerm.OptionValue.Value.doubleValue()>25000)
    ||
        (homeowner.Dwelling.HODW_BusinessProperty_HOE_Ext.HasHODW_OffPremises_Limit_HOETerm
            && homeowner.Dwelling.HODW_BusinessProperty_HOE_Ext.HODW_OffPremises_Limit_HOETerm.Value.doubleValue()>25000)
    ))
