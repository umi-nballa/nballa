...
class BP7ApartmentBuildingsTenantsAutosScheduledItemExpression extends DataBuilderExpression<BP7LineSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7ApartmentBuildingsTenantsAutosScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7ApartmentBuildingsTenantsAutosScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withLocation(value : DataBuilderExpression) : BP7ApartmentBuildingsTenantsAutosScheduledItemExpression {
