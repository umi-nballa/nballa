 ...
 *  Date:      01/August/2016
 **/
package una.integration.lexisnexis.clueproperty

uses java.lang.System
uses gw.api.system.logging.LoggerFactory
uses gw.pl.logging.LoggerCategory
uses wsi.schema.una.inscore.cprulesorderschema.Order
uses wsi.schema.una.inscore.cprulesorderschema.anonymous.elements.Order_Client
uses wsi.schema.una.inscore.cprulesorderschema.Accounting
uses wsi.schema.una.inscore.cprulesorderschema.Pnc
uses wsi.schema.una.inscore.cprulesorderschema.RulePlan
uses wsi.schema.una.inscore.cprulesorderschema.anonymous.elements.Order_Products
uses wsi.schema.una.inscore.cprulesorderschema.anonymous.elements.Order_Dataset
...
uses una.integration.lexisnexis.properties.lexisnexis
