...
uses gw.policy.PolicyLineConfiguration
 ...
 class BP7LineSchedExclItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : BP7LineSchedExclItem as readonly Owner

  construct(item : BP7LineSchedExclItem) {
    _owner = item
  }
  ...
  override function addExclusion(clause : Exclusion) {
   _owner.Exclusion = clause as BP7LineSchedExclItemExcl
  }
