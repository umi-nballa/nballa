...
class UNAReplCostCovA2_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {
    ...
    && Double.parseDouble(homeowner.Dwelling.CoverageALimitValue_Ext)>1.5*homeowner.Dwelling.HODW_Dwelling_Cov_HOE.HODW_Dwelling_Limit_HOETerm.Value.doubleValue())
