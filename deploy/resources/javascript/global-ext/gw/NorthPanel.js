...
//                align: 'stretch'
    ...
    Ext.define('gw.gInfoBarItem', {
      ...
      // @SenchaUpgrade Overriding template
      // Ideally removing unselectable should be done programmatically
      // But renderTpl changes from array to an object in the widget creation
      // Remove unselectable so that we can select text in infobar.
      renderTpl: [
