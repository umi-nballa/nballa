 ...
 */
class UNAUWPriorLoss26_each implements IRuleCondition<HomeownersLine_HOE>{
...
//Any prior loss with CLUE or Agent Cause of Loss = "Fire" and Date of Loss is in last 3 years
    ...
    homeowner.HOPriorLosses_Ext.each( \ elt ->
    {
      ...
      {
        if((elt1.LossCause_Ext==typekey.LossCause_Ext.TC_FIRE)
