 ...
 */
class UNAUWPriorLoss43_each implements IRuleCondition<HomeownersLine_HOE>{
  override function evaluateRuleCriteria(homeowner : HomeownersLine_HOE) : RuleEvaluationResult {

    //3 or more claims (UNA claims + CLUE or Agent Entered)  in 5 years, regardless of amount paid, excluding Equipment Breakdown losses.
