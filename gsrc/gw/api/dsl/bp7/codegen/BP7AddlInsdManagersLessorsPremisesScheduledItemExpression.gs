...
class BP7AddlInsdManagersLessorsPremisesScheduledItemExpression extends DataBuilderExpression<BP7LocSchedCovItemBuilder> {
  ...
  function with(clauseExpression : DataBuilderExpression) : BP7AddlInsdManagersLessorsPremisesScheduledItemExpression {
  ...
  function withScheduleNumber(value : java.lang.Integer) : BP7AddlInsdManagersLessorsPremisesScheduledItemExpression {
    _builder.withScheduleNumber(value)
    return this
  }
  
  function withDesignationOfPremises(value : String) : BP7AddlInsdManagersLessorsPremisesScheduledItemExpression {
