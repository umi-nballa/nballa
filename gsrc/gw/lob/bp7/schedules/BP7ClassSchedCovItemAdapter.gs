...
class BP7ClassSchedCovItemAdapter extends AbstractScheduledItemAdapter {

  var _owner : BP7ClassSchedCovItem as readonly Owner

  construct(item : BP7ClassSchedCovItem) {
    _owner = item
  }
  ...
  override function addCoverage(clause : Coverage) {
   _owner.addToCoverages(clause as BP7ClassSchedCovItemCov)
  }

  override function removeCoverage(clause : Coverage) {
    _owner.removeFromCoverages(clause as BP7ClassSchedCovItemCov)
  }
