...
class ReinsuranceConfigPlugin implements IReinsuranceConfigPlugin {
  ...
  override function shouldPolicyTermGenerateReinsurables(period : PolicyPeriod) : boolean {
    // It may make sense for customers phasing in
...
// return period.PeriodStart.after("01/01/2015" as java.util.Date)
...
//      if (DateUtil.compareIgnoreTime(period.PeriodStart, "01/01/2016" as java.util.Date) >= 0) {
//        return false
//      }
//    }
