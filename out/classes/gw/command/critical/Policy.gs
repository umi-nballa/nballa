...
class Policy extends BaseCommand
{
  ...
  @Argument("PolicyLine", {"wc", "pa", "ba", "bop", "cp", "gl", "im"})
  ...
  function createCCPolicy() {
    ...
    if (Policy.finder.findPolicyByPolicyNumber("4775949863-03") != null) {
      ...
      var cancellationPeriod = new CancellationBuilder().withBasedOnPeriod(renewalPeriod).withEffectiveDate(canDate).createAndCommit()
